...
#define	GPIO(X)		(X)
#ifndef __ARCH_ARM_MACH_MSM_BOARD_K2_CL_H
#define __ARCH_ARM_MACH_MSM_BOARD_K2_CL_H
#define MSM_LCD_TE					GPIO(0)
#define MSM_WL_REG_ON				GPIO(1)
#define MSM_V_RAW_1V2_EN			GPIO(2)
#define MSM_HW_RST_CLR				GPIO(3)
#define MSM_CAM_MCLK1				GPIO(4)
#define MSM_CAM_MCLK0				GPIO(5)
#define MSM_WL_HOST_WAKE			GPIO(6)
#define MSM_TP_ATTz					GPIO(7)
#define MSM_V_TP_3V3_EN				GPIO(8)
#define MSM_V_CAM_D1V8_EN			GPIO(9)
#define MSM_SD_CDETz				GPIO(10)
#define MSM_MB_ID1					GPIO(11)
#define MSM_NC_GPIO_12				GPIO(12)
...
#define MSM_V_LCMIO_1V8_EN			GPIO(36)
#define MSM_V_LCM_3V3_EN			GPIO(37)
#define MSM_AUD_LS_EN				GPIO(38)
...
#define MSM_AUD_FM_I2SSYNC			GPIO(47)
#define MSM_AUD_FM_I2SBCLK			GPIO(48)
#define MSM_AUD_FM_I2SDIN			GPIO(49)
#define MSM_RAW_INTR1				GPIO(50)
#define MSM_RAW_RSTN				GPIO(51)
#define MSM_AUD_FM_I2SDOUT			GPIO(52)
#define MSM_CAM_VCM_PD				GPIO(53)
#define MSM_REGION_ID				GPIO(54)
#define MSM_V_BOOST_5V_EN			GPIO(55)
#define MSM_V_WL_IO_1V8_EN		GPIO(56)
#define MSM_NC_GPIO_57			GPIO(57)
...
#define MSM_AUD_SPK_EN				GPIO(75)
#define MSM_BT_REG_ON					GPIO(76)
#define MSM_V_CAMIO_1V8_EN		GPIO(77)
#define MSM_VOL_UPz						GPIO(78)
#define MSM_BT_DEV_WAKE				GPIO(79)
#define MSM_V_RAW_1V8_EN			GPIO(80)
...
#define MSM_V_CAM2_D1V2_EN		GPIO(93)
...
#define MSM_TRK_LO_ADJ				GPIO(109)
#define MSM_NC_GPIO_110				GPIO(110)
#define MSM_DRX_1X_EV_SEL			GPIO(111)
#define MSM_BOOT_CONFIG_6			GPIO(112)
#define MSM_NC_GPIO_113				GPIO(113)
#define MSM_NC_GPIO_114				GPIO(114)
#define MSM_BC0_SW_SEL0				GPIO(115)
...
#define MSM_PA1_R0						GPIO(120)
#define MSM_PA1_R1						GPIO(121)
#define MSM_PA0_R0						GPIO(122)
#define MSM_PA0_R1						GPIO(123)
#define MSM_WTR1_RF_ON				GPIO(124)
#define MSM_WTR0_RF_ON				GPIO(125)
#define MSM_WTR0_RX_ON				GPIO(126)
#define MSM_TX_AGC_ADJ				GPIO(127)
#define MSM_PA_ON8						GPIO(128)
#define MSM_PA_ON7				GPIO(129)
#define MSM_PA_ON6						GPIO(130)
#define MSM_PA_ON5						GPIO(131)
#define MSM_PA_ON4				GPIO(132)
#define MSM_PA_ON3						GPIO(133)
#define MSM_PA_ON2_GSMHB			GPIO(134)
#define MSM_PA_ON1						GPIO(135)
...
#define MSM_WTR1_SSBI_PRX_DRX	GPIO(140)
#define MSM_WTR1_SSBI_TX_GNSS	GPIO(141)
#define MSM_WTR0_SSBI_PRX_DRX	GPIO(142)
#define MSM_WTR0_SSBI_TX_GNSS	GPIO(143)
#define MSM_PARKING_BC0				GPIO(144)
#define MSM_V_3G_PA1_EN				GPIO(145)
...
#define PM_AP_BL_LED_LPG			PMGPIO(1)
...
extern struct msm_camera_board_info k2_camera_board_info;
extern struct platform_device k2_msm_rawchip_device;

int __init k2_cl_gpiomux_init(void);
int __init k2_cl_init_keypad(void);
void k2_allocate_fb_region(void);
void k2_mdp_writeback(struct memtype_reserve* reserve_table);
int __init k2_cl_init_mmc(void);
int __init k2_cl_wifi_init(void);
void __init k2_init_cam(void);
void k2_init_fb(void);
