/* linux/arch/arm/mach-msm/board-k2_cl-mmc.c
 *
...
static int
k2_cl_wifi_status_register(void (*callback)(int card_present, void *dev_id),
				void *dev_id)
{
	if (wifi_status_cb)
		return -EAGAIN;
...
{
	return k2_cl_wifi_cd;
}

static unsigned int k2_cl_wifislot_type = MMC_TYPE_SDIO_WIFI;
static unsigned int wifi_sup_clk_rates[] = {
	400000, 24000000, 48000000,
};
static struct mmc_platform_data k2_cl_wifi_data = {
	.ocr_mask               = MMC_VDD_28_29,
	.status                 = k2_cl_wifi_status,
	.register_status_notify = k2_cl_wifi_status_register,
	.embedded_sdio          = &k2_cl_wifi_emb_data,
	.mmc_bus_width  = MMC_CAP_4_BIT_DATA,
	.sup_clk_table	= wifi_sup_clk_rates,
	.sup_clk_cnt	= ARRAY_SIZE(wifi_sup_clk_rates),
	.slot_type = &k2_cl_wifislot_type,
...
int k2_cl_wifi_set_carddetect(int val)
{
...
EXPORT_SYMBOL(k2_cl_wifi_set_carddetect);

int k2_cl_wifi_power(int on)
{
...
EXPORT_SYMBOL(k2_cl_wifi_power);

int k2_cl_wifi_reset(int on)
{
